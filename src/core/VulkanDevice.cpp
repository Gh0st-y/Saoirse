...
// --- Find Queue Families (private, takes explicit device) ---
...
// --- Find Queue Families (public, uses member physicalDevice) ---
QueueFamilyIndices VulkanDevice::findQueueFamilies() const {
    return findQueueFamilies(physicalDevice);
}

// --- Query Swap Chain Support (private) ---
...
// --- Query Swap Chain Support (public) ---
...
// --- Create Image (standard 2D) ---
void VulkanDevice::createImage(uint32_t width, uint32_t height, VkFormat format,
    VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties,
    VkImage& image, VkDeviceMemory& imageMemory) {
    createImage(width, height, 1, 0, format, tiling, usage, properties, image, imageMemory);
}

// --- Create Image (full overload — arrayLayers + flags for cubemaps) ---
void VulkanDevice::createImage(uint32_t width, uint32_t height, uint32_t arrayLayers,
